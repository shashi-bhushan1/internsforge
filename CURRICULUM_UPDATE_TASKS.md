...
- [ ] Create `src/data/curriculum/amazonWebServices.ts`
- [ ] Create `src/data/curriculum/androidAppDevelopment.ts`
- [ ] Create `src/data/curriculum/constructionPlanning.ts`
- [ ] Create `src/data/curriculum/gameDevelopment.ts`
- [ ] Create `src/data/curriculum/geneticEngineering.ts`
- [ ] Create `src/data/curriculum/icEngine.ts`
- [ ] Create `src/data/curriculum/medicalCoding.ts`
- [ ] Create `src/data/curriculum/operationManagement.ts`
- [ ] Create `src/data/curriculum/robotics.ts`

### Step 2: Update Types
- [ ] Add new course types to `src/data/curriculum/types.ts`:
  - `'amazon-web-services'`
...
- [ ] Export new modules in `src/data/curriculum/index.ts`
- [ ] Add course configs for each new curriculum in `courseConfigs` object

### Step 4: Update Course Data
- [ ] Update `courseType` field in `src/data/courses.ts` for each course:
...
- [ ] Add cases in `getModules()` function in `src/components/courses/CourseCurriculum.tsx` for each new course type
