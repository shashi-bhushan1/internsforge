...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "AutoCAD Course - InternsForge",
    ...
    url: "https://internsforge.com/courses/autocad",
  },
  twitter: {
    title: "AutoCAD Course - InternsForge",
    description: "Master CAD software and construction planning. Learn architectural design, project management, and building information modeling.",
...
export default function AutoCADPage() {
  const paymentLinks = getPaymentLinks('autocad');
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Course",
    "name": "AutoCAD Course",
    "description": "Comprehensive AutoCAD course covering CAD software, architectural design, and construction planning. Build expertise in CAD technologies.",
    "provider": {
      ...
      <div className="min-h-screen bg-brand-page">
        ...
        <main className="w-full">
          ...
          <CourseKeyBenefits 
            capstoneProjects={2}
          />
          <CourseCurriculum courseType="autocad" courseName="AutoCAD Course" />
          <PricingPlans 
