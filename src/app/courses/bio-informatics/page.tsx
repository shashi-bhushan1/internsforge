...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Bio-Informatics Course - InternsForge",
    ...
    url: "https://internsforge.com/courses/bio-informatics",
  },
  twitter: {
    title: "Bio-Informatics Course - InternsForge",
    description: "Explore medical technologies and healthcare informatics. Learn medical coding, bioinformatics, and genetic engineering applications.",
...
export default function BioInformaticsPage() {
  const paymentLinks = getPaymentLinks('bio-informatics');
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Course",
    "name": "Bio-Informatics Course",
    "description": "Comprehensive Bio-Informatics course covering healthcare informatics and bioinformatics. Build expertise in medical technologies.",
    "provider": {
      ...
      <div className="min-h-screen bg-brand-page">
        ...
        <main className="w-full">
          ...
          <CourseKeyBenefits 
            capstoneProjects={2}
          />
          <CourseCurriculum courseType="bio-informatics" courseName="Bio-Informatics Course" />
          <PricingPlans 
