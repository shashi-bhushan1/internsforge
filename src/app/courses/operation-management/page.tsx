...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Operation Management Course - InternsForge",
    ...
    url: "https://internsforge.com/courses/operation-management",
  },
  twitter: {
    title: "Operation Management Course - InternsForge",
    description: "Develop leadership and management skills. Learn strategic planning, team management, and organizational effectiveness.",
...
export default function OperationManagementPage() {
  const paymentLinks = getPaymentLinks('operation-management');
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Course",
    "name": "Operation Management Course",
    "description": "Comprehensive Operation Management course covering strategic planning, team management, and organizational effectiveness. Build expertise in operations.",
    "provider": {
      ...
      <div className="min-h-screen bg-brand-page">
        ...
        <main className="w-full">
          ...
          <CourseKeyBenefits 
            capstoneProjects={2}
          />
          <CourseCurriculum courseType="web-development" courseName="Operation Management Course" />
          <PricingPlans 
