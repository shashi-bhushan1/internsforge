    ...
    <section className="bg-brand-page py-8 md:py-12 px-4 sm:px-6 md:px-12 lg:pl-[145px] lg:pr-[145px]">
      <div className="max-w-[1600px] mx-auto">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
          ...
          <div className="lg:max-w-[400px] lg:pt-8 lg:mt-8">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 md:mb-6 whitespace-nowrap">
              Perks Of Learning With Us
            </h2>
          ...
          <div className="flex-1 w-full max-w-[500px] lg:ml-auto">
