...
export default function EducationalAlliances() {
  return (
    <section className="bg-white py-16 pl-[145px] pr-[145px] relative">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="bg-gray-100 rounded-2xl h-[408px] p-4">
          <div className="grid lg:grid-cols-2 gap-8 items-center h-full">
            {/* Left Panel - Text Content */}
            <div className="space-y-6 ml-16 flex flex-col justify-center h-full">
              <h2 className="text-2xl font-bold text-gray-800">
                Shaping the Future Through<br />
                Powerful Educational Alliances
              </h2>
              <p className="text-[13px] text-gray-700 leading-6 italic">
            ...
            <div className="grid grid-cols-3 gap-2 mr-16 ml-12">
      ...
      <div className="fixed bottom-8 right-8 flex flex-col gap-4 z-50">
        <button className="w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center hover:bg-gray-400 transition-colors shadow-lg">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 19V5M5 12L12 5L19 12" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
        <button className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors shadow-lg">
