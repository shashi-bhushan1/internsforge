...
export default function PricingPlans() {
  return (
    <section id="pricing-plans" className="bg-brand-page py-8 md:py-16 pb-16 md:pb-24 px-4 sm:px-6 md:px-12 lg:pl-[145px] lg:pr-[145px] scroll-mt-32 md:scroll-mt-36">
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-3xl mx-auto justify-items-center pb-8">
          {plans.map((plan) => (
            <div
              key={plan.id}
              className="relative bg-[#f7f2e1] rounded-xl shadow-md overflow-visible hover:shadow-lg transition-shadow w-full max-w-[350px] flex flex-col border border-gray-200"
            >
