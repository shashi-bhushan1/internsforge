            ...
            <div className="text-center">
              <div className="flex justify-center mb-4">
                <a 
                  ...
                  aria-label="Call us at +91 7019680860"
                >
              ...
              <a href="tel:+917019680860" className="block text-base md:text-lg text-gray-700 hover:text-brand-cyan transition-colors font-medium">
                +91 7019680860
              </a>
            </div>
            ...
            <div className="text-center">
              <div className="flex justify-center mb-4">
                <a 
                  ...
                  className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-orange-50 flex items-center justify-center shadow-sm border border-orange-200 hover:bg-brand-cyan hover:border-brand-cyan transition-all duration-300 cursor-pointer group"
                  aria-label="Message us on WhatsApp at +91 7019680860"
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-brand-orange group-hover:text-white transition-colors duration-300">
              ...
              <a href="https://wa.me/917019680860" target="_blank" rel="noopener noreferrer" className="block text-base md:text-lg text-gray-700 hover:text-brand-cyan transition-colors font-medium">
                +91 7019680860
              </a>
            </div>
          </div>
