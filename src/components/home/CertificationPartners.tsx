        ...
        <div className="w-full max-w-[864px] min-h-[316px] mx-auto flex flex-col mb-8 md:mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 md:gap-5 flex-1">
            {partners.map((partner, index) => (
              <div
                key={index}
                className={`bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 flex items-center justify-center ${
                  partner.name === "ESB" 
        ...
        <div className="w-full max-w-[688px] mx-auto">
          <div className="p-4 md:p-6">
            ...
            {otherPartners.map((partner, index) => (
              <div
                key={index}
                className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 p-3 md:p-4 flex items-center justify-center min-h-[120px] md:min-h-[140px]"
              >
                <Image
                  src={partner.logo}
                  alt={partner.name}
